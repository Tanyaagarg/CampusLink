                                            ...
                                            {group.items && group.items.map((item: any, iIndex: number) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        {item.image && (
                                                            <div
                                                                className="w-10 h-10 rounded-md overflow-hidden flex-shrink-0 bg-[#222] cursor-pointer hover:opacity-80 transition-opacity"
                ...
                >
                    <div className="relative max-w-4xl max-h-[90vh] w-full h-full flex items-center justify-center">
                        ...
                        <button
                            ...
                            onClick={() => setSelectedImage(null)}
                        >
                            <ExternalLink className="w-6 h-6 rotate-180" /> {/* Using ExternalLink as Close icon (rotated) or just X if imported */}
                        </button>
                    </div>
                </div>
            )}
